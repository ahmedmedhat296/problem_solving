...
- **problem.md** - Problem description, input/output format, constraints, and examples (only for Codeforces problems)

## 🎯 Problems Included

### Algorithm & Data Structure Problems

#### 1. [Array Stack Implementation](./array_stack_implementation/)
...
#### 3. [HTML Tag Matcher](./html_tag_matcher/)
...
#### 4. [Array-Based Binary Search Tree](./array_based_bst/)
...
#### 5. [Maximum Subarray (Divide and Conquer)](./maximum_subarray_divide_conquer/)
...
#### 6. [Matrix Operations Class](./matrix_operations_class/)
...
#### 7. [Manacher's Algorithm](./manacher_algorithm/)
...
#### 8. [Abraham's Great Escape](./Abrahams_Great_Escape/)
A Codeforces problem solution involving grid path construction and movement simulation.

#### 9. [Against the Difference](./Against_the_Difference/)
...
#### 18. [Monocarp's String](./Monocarps_String/)
...
#### 19. [Need More Arrays](./Need_More_Arrays/)
...
3. **Read the documentation:**
   ...
   - Check `problem.md` for problem description (Codeforces problems only)
...
- **Total Problems**: 23
- **Algorithm & Data Structure Problems**: 7
...
- Each solution includes detailed documentation in `README.md`
- Time and space complexity analysis is provided for each problem
- Solutions are organized for easy navigation and learning
- Codeforces problems include `problem.md` files with links to the original problems on Codeforces
